      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="rise border-t border-[#e2ddd8]">
          {listings.map((l) => (
            ...
            >
              {/* Status dot */}
              <div className={`w-2 h-2 rounded-full flex-shrink-0 ${l.tag === 'Sold' ? 'bg-[#ccc8c2]' : l.tag === 'Featured' ? 'bg-[#ff4423]' : 'bg-[#2a8a4f]'}`} />

              {/* Address */}
              <div className="flex-1 min-w-0">
                <div className="font-display font-700 text-[#0d0d0d] text-lg md:text-2xl group-hover:text-[#ff4423] transition-colors truncate">
                  {l.address}
                </div>
              ...
              <span className={`flex-shrink-0 text-xs font-display font-700 tracking-widest uppercase px-3 py-1.5 ${
                ...
                'text-[#2a8a4f] border border-[#b8dcca]'
              }`}>
                {l.status}
              </span>
              ...
              {/* Arrow */}
              <svg className="flex-shrink-0 text-[#ccc8c2] group-hover:text-[#ff4423] transition-colors" width="20" height="20" viewBox="0 0 24 24" fill="none">
        ...
        <div className="rise mt-10 flex items-center justify-between">
          ...
          <a href="#contact" className="inline-flex items-center gap-3 bg-white border border-[#e2ddd8] text-[#0d0d0d] font-display font-700 text-sm tracking-wide px-6 py-3 hover:border-[#ff4423] hover:text-[#ff4423] transition-colors duration-200">
