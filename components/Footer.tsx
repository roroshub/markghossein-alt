export function Footer() {
  return (
    <footer className="bg-[#f5f2ed] border-t border-[#e2ddd8]">
            ...
            <div className="flex gap-2">
              {['IG', 'FB', 'LI', 'YT'].map((s) => (
                <a
                  key={s}
                  href="#"
                  className="w-8 h-8 border border-[#e2ddd8] flex items-center justify-center text-[#bbb] text-xs font-display font-700 hover:border-[#ff4423] hover:text-[#ff4423] transition-colors"
                >
                  {s}
                </a>
              ))}
