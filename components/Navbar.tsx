    ...
    <>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-10 h-14 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur border-b border-[#e2ddd8]' : ''}`}>
        ...
        <button
          ...
          className="flex items-center gap-2 text-[#999] hover:text-[#0d0d0d] transition-colors text-sm tracking-widest uppercase font-display"
        >
          Menu
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 md:px-10 h-14 border-b border-[#e2ddd8]">
          ...
          <button
            ...
            className="text-[#999] hover:text-[#0d0d0d] transition-colors text-sm tracking-widest uppercase font-display flex items-center gap-2"
          >
            Close
        ...
        <div className="px-6 md:px-16 pb-8 flex items-center gap-6 text-[#bbb] text-xs tracking-wider uppercase">
          ...
          <span className="w-4 h-px bg-[#d8d4ce]" />
          <a href="mailto:mark.ghossein@c21.ca" className="hover:text-[#0d0d0d] transition-colors">
