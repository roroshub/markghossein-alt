    ...
    <section id="process" ref={ref} className="bg-white py-24 md:py-36">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="rise grid md:grid-cols-[1fr_auto] gap-8 items-end mb-16">
          ...
          >
            The Five-Step<br /><span className="text-[#1b4332]">Framework.</span>
          </h2>
          <a href="#contact" className="inline-flex items-center gap-3 bg-[#1b4332] text-white font-display font-700 text-sm tracking-wide px-6 py-3 hover:bg-[#14332a] transition-colors whitespace-nowrap">
            Get Free Guide
